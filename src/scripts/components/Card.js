export class Card {
  ...
  _getTemplate() {
    return document.querySelector(this.cardTemplate).content.cloneNode(true);
  }
  
  generateCard() {
    this._cardElement = this._getTemplate();
    this._cardElementContainer = this._cardElement.querySelector('.element__template');
